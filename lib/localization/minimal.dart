...
class Demo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      supportedLocales: [
        const Locale('en', ''), // ここを削除するとうまく行くけどね
        const Locale('ja', ''),
      ],
      ...
      // 注意：MaterialAppは、指定されたデリゲートを使用してローカリゼーションウィジェットを作成します。
      // DemoLocalizations.of（）は、そのコンテキストがアプリの子である場合にのみ、
      // アプリのローカリゼーションウィジェットを検索します。
      home: DemoApp(),
    );
  }
}
